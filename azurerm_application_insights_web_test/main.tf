...
resource "azurerm_application_insights_web_test" "web_test" {
  ...
  configuration = <<XML
  <WebTest Name="${lookup(var.web_tests[count.index], "name")}" Id="ABD48585-0831-40CB-9069-682EA6BB3583" Enabled="True"
    ...
    <Items>
      <Request Method="${lookup(var.web_test[count.index], "method", "GET")}" Guid="a5f10126-e4cd-570d-961c-cea43999a200"
